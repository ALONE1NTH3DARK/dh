  ...
  return (
    ...
    >
      <button
        ...
        className={`group relative z-10 flex w-full items-center gap-4 px-5 py-4 text-left transition-colors duration-300 hover:bg-white/[0.03] md:px-14 md:py-5 ${
          ...
          >
            <div className="relative px-5 pb-24 pt-8 md:px-10 md:pb-32 md:pt-10">
              ...
              <div className="relative mx-auto grid w-full max-w-[1200px] items-center gap-12 sm:gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
                <Reveal>
                  <SectionLabel>К каждому сайту</SectionLabel>

                  <h2 className="font-display text-[clamp(2.25rem,5.5vw,3.6rem)] font-semibold uppercase leading-[1.20] text-pretty">
                    <span className="text-ink">Электронная визитка </span>
                    <span className="text-gradient-neon whitespace-nowrap">в подарок</span>
                  </h2>

                  <p className="mt-5 max-w-xl text-[17px] leading-relaxed text-mute">
                    Цифровая визитка в стиле вашего бренда: контакты, соцсети
                    и ссылка на сайт в одном экране. Клиент сканирует QR или открывает
                    ссылку — и сразу может позвонить, написать или сохранить контакт.
                  </p>

                  <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-mute/70">
                    Это не доплата и не апселл — визитка идёт в подарок к каждому проекту.
                  </p>
